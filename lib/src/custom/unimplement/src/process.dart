...
//   /// [comparatorBurst]
//   ///
//   static int comparatorArrival<P>(ProcessUnit<P> a, ProcessUnit<P> b) =>
...
//
//   ProcessUnit<P> terminateByArrival(ProcessUnit<P> another) =>
//       ProcessUnit(process, arrival, burst - turnaroundTime(another.arrival));
//
...
// ///
// ///
// class ProcessUnitList<P> implements I_OperatableIndexable<ProcessUnit<P>> {
//   ///
//   /// overrides
//   ///
//   @override
...
//       ProcessSchedule.sequence => _units.iterator.mapToList(
//         (unit) =>
