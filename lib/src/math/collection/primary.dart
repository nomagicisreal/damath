...
extension IteratorDouble on Iterator<double> {
  ...
  Iterable<double> operatePlus(int v) => takeAllApply((o) => o + v);

  Iterable<double> operateSubtract(int v) => takeAllApply((o) => o - v);

  Iterable<double> operateMultiply(int v) => takeAllApply((o) => o * v);

  Iterable<double> operateDivide(int v) => takeAllApply((o) => o / v);

  Iterable<double> operateDivideToInt(int v) =>
      takeAllApply((o) => (o ~/ v).toDouble());
...
extension IterableDouble on Iterable<double> {
  ...
  Iterable<double> get standardUnit {
    ...
    return iterator.takeAllApply((value) => value / distance);
  }
